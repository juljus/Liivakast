# Importing additional command blocks
import pygame
import os
...
# Defining the FPS value of the main game loop
FPS = 30
...
# Defining functions for the main game loop
...
def red_handle_movement(keys_pressed, red):
    if keys_pressed[pygame.K_LEFT] and red.x - VEL >= BORDER.x + BORDER.width + 7:  # LEFT
        red.x -= VEL
...
# Main function which contains the main game loop
def main():
    ...
    while run:
        ...
        for event in pygame.event.get():
            ...
            # Ends the main game loop when the "quit" button is pressed
            if event.type == pygame.QUIT:
                run = False

                # Quits the window when the main game loop ends
                pygame.quit()
...
# Only lets the main game loop to run when the file is played directly
